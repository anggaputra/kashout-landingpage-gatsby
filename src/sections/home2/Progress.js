            ...
            <div className={className} {...rest}>
                <div className='container'>
                    ...
                    <div className='row justify-content-center'>
                        <div className='col-xl-7 col-lg-8 col-md-9 col-xs-10 pt-13 pt-lg-23 pb-13 pb-lg-12 pr-lg-10 pr-xl-0'></div>
                    </div>
                    {/* <!-- Section Title --> */}
                    {/* <!-- Progress Items --> */}
                    <div className='row justify-content-center'>
                                ...
                                >
                                    ...
                                    <div className=''>
                                        ...
                                        <p
                                            ...
                                            style={{ color: "#fff" }}
                                        >
                                            Cari produk yang diinginkan di
                                            Kashout, pilih produk yang sesuai
                                ...
                                >
                                    ...
                                    <div className=''>
                                        ...
                                        <p
                                            ...
                                            style={{ color: "#fff" }}
                                        >
                                            Menabung sesuai kemampuan keuangan
                                            Kamu sampai target menabung
                                            tercapai.
                                        </p>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div className=''>
                                        ...
                                        <p
                                            ...
                                            style={{ color: "#fff" }}
                                        >
                                            Dapatkan produknya tanpa menambah
                                            beban keuangan Kamu.
                                        </p>
                                    </div>
                                </div>
